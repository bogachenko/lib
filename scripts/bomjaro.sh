...
pacman -Syyuu
pacman -S firefox-i18n-ru firefox vim vlc steam-native-runtime steam opera opera-ffmpeg-codecs gimp ttf-liberation ttf-dejavu opendesktop-fonts ttf-bitstream-vera ttf-arphic-ukai ttf-arphic-uming ttf-hanazono ttf-ubuntu-font-family jre-openjdk jdk-openjdk jre-openjdk-headless capitaine-cursors discord telegram-desktop zsh thunderbird-i18n-ru thunderbird gparted wine wine-gecko wine-mono virtualbox qbittorrent pepper-flash
chsh -s /bin/zsh
cd /home/$USER
...
rm -rf /tmp/*
exit
yaourt -S ttf-ms-fonts vscodium-bin github-desktop-bin ffmpeg-full
sudo chsh -s /bin/zsh
