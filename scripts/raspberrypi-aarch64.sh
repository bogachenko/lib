...
#   Tether (USDT) uses TRX, ETH, BNB, TON, SOL, OP, ARB, POL or CELO addresses, depending on the type of chain chosen.
#   USD Coin (USDC) uses TRX, ETH, BNB, SOL, OP, ARB, POL or CELO addresses, depending on the type of chain chosen.
